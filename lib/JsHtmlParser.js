...
function JsHtmlParser(writeCallback, options) {
	...
	var expressionSetDictionary = {
		...
		, anchorIfElse1:	util.map(expressionSetSource, 'jsControlBlock', 'jsGroup', 'jsArray', 'jsSingleQuote', 'jsDoubleQuote', 'text', 'tag', 'anchorIfElse2')
		, anchorIfElse2:	util.map(expressionSetSource, 'jsControlBlock', 'jsGroup', 'jsArray', 'jsSingleQuote', 'jsDoubleQuote', 'text', 'tag', 'anchorIfElse3')

		, anchorFor:	util.map(expressionSetSource, 'jsBlock', 'jsGroup', 'jsArray', 'jsSingleQuote', 'jsDoubleQuote', 'anchorFor1')
		, anchorFor1:	util.map(expressionSetSource, 'jsControlBlock', 'jsGroup', 'jsArray', 'jsSingleQuote', 'jsDoubleQuote', 'text', 'tag', 'anchorFor2')

		, anchorWhile:	util.map(expressionSetSource, 'jsBlock', 'jsGroup', 'jsArray', 'jsSingleQuote', 'jsDoubleQuote', 'anchorWhile1')
		, anchorWhile1:	util.map(expressionSetSource, 'jsControlBlock', 'jsGroup', 'jsArray', 'jsSingleQuote', 'jsDoubleQuote', 'text', 'tag', 'anchorWhile2')

		, anchorDoWhile:	util.map(expressionSetSource, 'jsControlBlock', 'jsGroup', 'jsArray', 'jsSingleQuote', 'jsDoubleQuote', 'text', 'tag', 'anchorDoWhile1')
		...
		, anchorSwitch1:	util.map(expressionSetSource, 'jsControlBlock', 'jsGroup', 'jsArray', 'jsSingleQuote', 'jsDoubleQuote', 'text', 'tag', 'anchorSwitch2')

		, anchorWith:	util.map(expressionSetSource, 'jsBlock', 'jsGroup', 'jsArray', 'jsSingleQuote', 'jsDoubleQuote', 'anchorWith1')
		, anchorWith1:	util.map(expressionSetSource, 'jsControlBlock', 'jsGroup', 'jsArray', 'jsSingleQuote', 'jsDoubleQuote', 'text', 'tag', 'anchorWith2')

		, anchorFunction:	util.map(expressionSetSource, 'jsBlock', 'jsGroup', 'jsArray', 'jsSingleQuote', 'jsDoubleQuote', 'anchorFunction1')
		, anchorFunction1:	util.map(expressionSetSource, 'jsControlBlock', 'jsGroup', 'jsArray', 'jsSingleQuote', 'jsDoubleQuote', 'text', 'tag', 'anchorFunction2')
		...
		, jsControlBlock:	util.map(expressionSetSource, 'jsControlBlock1', 'jsBlock', 'jsGroup', 'jsArray', 'jsSingleQuote', 'jsDoubleQuote', 'text', 'tag')
