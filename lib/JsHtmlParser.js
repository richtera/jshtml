...
function JsHtmlParser(writeCallback, options) {
	...
	var parser = this;
	var expressions = require('./expressions')(options);
	var filters = require('./filters')(options);
	var tokenizer = new Tokenizer(onToken, expressions);
	var line = 0;
